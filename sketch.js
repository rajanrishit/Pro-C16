...
function draw() {
  ...
  if(gameState===PLAY){
    monsterGroup.velocityX=-(4+3*score/2);
   fruit1.velocityX=-(9+1*score/2);
   fruit2.velocityX=-(4+3*score/2);
   fruit3.velocityX=-(4+3*score/2);
   fruit4.velocityX=-(4+3*score/2);
  ...
  if(fruitGroup.isTouching(knife)){
    ...
    else
    {
     ...
     knife.addImage("knifeImg",endImg);
     knife.scale=0.7;
      }
    }
  }
